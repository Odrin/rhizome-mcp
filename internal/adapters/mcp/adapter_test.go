...
func TestRelationToolsLifecycleAndContracts(t *testing.T) {
	...
	wantNames := []string{"add_comment", "apply_import", "apply_issue_plan", "archive_issue", "cancel_review_request", "claim_issue", "create_agent_session", "create_issue", "create_review_request", "end_agent_session", "evaluate_gates", "export_project", "finish_attempt", "get_changes", "get_issue", "get_issue_activity", "get_issue_graph", "get_planning_graph", "get_project", "get_resource_reservation", "get_review_request", "get_work_context", "get_workflow_policy", "list_decisions", "list_issues", "list_labels", "list_resource_reservations", "list_review_requests", "list_workflow_policies", "manage_issue_relation", "manage_workflow_policy", "open_project", "record_decision", "release_resources", "renew_attempt", "replace_review_request", "reserve_resources", "save_attempt_note", "search", "submit_gate_evidence", "unarchive_issue", "update_issue", "validate_import", "validate_issue_plan"}
